...
class SecurityEvent(StrEnum):
    ...
    MIXED_GUIDANCE_REJECTED = "MIXED_GUIDANCE_REJECTED"
    UNGROUNDED_FACT_REQUEST = "UNGROUNDED_FACT_REQUEST"
    ...
    AI_OUTPUT_UNGROUNDED = "AI_OUTPUT_UNGROUNDED"
    AI_OUTPUT_NEW_NUMBER = "AI_OUTPUT_NEW_NUMBER"
    AI_OUTPUT_NEW_URL = "AI_OUTPUT_NEW_URL"
    AI_OUTPUT_NEW_ENTITY = "AI_OUTPUT_NEW_ENTITY"
...
_CATEGORY_EVENTS = {
    ...
    "MIXED_VALID_AND_INVALID_GUIDANCE": SecurityEvent.MIXED_GUIDANCE_REJECTED,
    "UNGROUNDED_FACT_REQUEST": SecurityEvent.UNGROUNDED_FACT_REQUEST,
