...
class LegalEntity(Base):
    ...
    lookup_provider: Mapped[str | None] = mapped_column(String(32))
    lookup_provider_reference: Mapped[str | None] = mapped_column(String(128))
    lookup_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
    registry_status: Mapped[str | None] = mapped_column(String(32))
    lookup_invalid: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    lookup_metadata: Mapped[dict | None] = mapped_column(JSONB)
